...
var allActivities = [];
var map;
var newIcon = '/assets/info-afd5ac2ed389bb791d60c5b0725cf1bc937d04c9c39da01617d02a5f1245f277.png';
var icons = {
  childrenClasses: {
    name: 'Children\'s class',
    icon: '/assets/childrenClasses-6170376d71e22589c0c9e17bf382e7302de98f894a4f903cef232c6dad7628ce.png'
  },
  devotionalMeetings: {
    name: 'Devotional meeting',
    icon: '/assets/devotionalMeetings-a9cdef1b8b32b54b45dd980a41d29cd2dc1b10a59b8a2ef31c1a50c33959cb99.png'
  },
  juniorYouthGroups: {
    name: 'Junior youth group',
    icon: '/assets/juniorYouthGroups-066ee2fff3fb124dc159f8e4f264c73152e7f9e93224cff6f1d6a157c27eb45d.png'
  },
  studyCircles: {
    name: 'Study circle',
    icon: '/assets/studyCircles-b7db80d84736b1b02a5861b6ebf7c185bb9fd86df509d7bf8d4af592dbc7a48e.png'
  }
};
var infowindow;
var tempMarker;
...
function showHideUniqueField(activityCategory) {
  if (activityCategory != 'devotionalMeetings') {
    ...
    else if (activityCategory == 'studyCircles') {
